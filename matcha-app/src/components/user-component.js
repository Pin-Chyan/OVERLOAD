...
//
    constructor(props){
        ...
        server_get(this.ip,this.jwt).then(res => {
            ...
            if (this.props.location.user && this.props.location.user.liked && this.props.location.user.viewed && this.props.location.user.img) {
    ...
    userData_getter(){
        ...
        get_data(this.state.user.email,this.jwt,this.ip,"name email last bio tag img viewed liked likes sexual_pref gender ").then(userGet_res => {
