...
image_constructor(new_img){
	...
	var div = (		  
		...
		<input id="1" className="file-input" type="file" name="resume" /></label>
...
image_edit_constructor(images){
	var element = (
		<div className="tile is-vertical">
			<div id="bruh" className="tile"></div>
	...
	var img = (
		...
		<figure className="image is-4by3"><div id={"img1"+this.div_key}></div></figure>
	  </article></div>
	);
}
